...
const Hero = ({ imageUrl, quote, name }: HeroProps) => {
    return (
        <section className="w-full min-h-[70vh] flex flex-col md:flex-row items-center justify-center text-center md:text-left bg-gradient-to-br from-blue-900 to-purple-800 text-white px-6 py-12">
            {/* Image Section */}
